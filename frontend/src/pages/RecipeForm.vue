  ...
  <div class="p-4 sm:ml-64 pt-[20px] h-[100vh]">
    ...
    <form  class="max-w-[700px] mx-auto mt-[100px] shadow-md p-8 rounded-lg space-y-5">
      ...
      <div class="mb-5">
        ...
        <select class="border block w-full p-2 rounded-xl border-gray-400 bg-[#F9FAFB] shadow" >
      ...
      <input type="file" class="block my-8" accept="image/png, image/jpeg" required>
      <div >
        <img class="h-[300px] w-full object-cover"  alt="">
      </div>
